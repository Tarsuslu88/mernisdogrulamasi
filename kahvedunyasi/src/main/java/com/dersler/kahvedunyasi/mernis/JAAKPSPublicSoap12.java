...
public class JAAKPSPublicSoap12
{
    interface JAAIWcfMethod
    {
        JAAExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(JAAExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public JAAKPSPublicSoap12(){}

    public JAAKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public JAAKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected JAAExtendedSoapSerializationEnvelope createEnvelope()
    {
        JAAExtendedSoapSerializationEnvelope envelope= new JAAExtendedSoapSerializationEnvelope(JAAExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,JAAExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,JAAExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new JAAIWcfMethod()
        {
            @Override
            public JAAExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                JAAExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(JAAExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(JAAIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        JAAExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,JAAExtendedSoapSerializationEnvelope envelope)
    {
