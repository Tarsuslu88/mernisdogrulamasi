...
class JAASoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class JAAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JAADateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new JAAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JAADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JAADateTimeConverter dateTimeConverter = new JAAStandardDateTimeConverter();

    public JAAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JAAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JAAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JAAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JAAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JAAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
