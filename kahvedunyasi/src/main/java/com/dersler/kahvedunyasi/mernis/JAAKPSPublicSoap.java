...
public class JAAKPSPublicSoap
{
    ...
    public JAAKPSPublicSoap(){}

    public JAAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JAAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JAAExtendedSoapSerializationEnvelope envelope= new JAAExtendedSoapSerializationEnvelope(JAAExtendedSoapSerializationEnvelope.VER11);
